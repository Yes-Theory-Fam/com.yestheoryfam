...
import OneFourLayout, {
  props as OFLProps,
} from "./OneFourLayout/OneFourLayout";
import DoubleRowLayout, {
  props as DRLProps,
} from "./DoubleRowLayout/DoubleRowLayout";
import VerticalLeftLayout, {
  props as VLLProps,
} from "./VerticalLeftLayout/VerticalLeftLayout";
import DoubleColumnLayout, {
  props as DCLProps,
} from "./DoubleColumnLayout/DoubleColumnLayout";
import DoubleVerticalLayout, {
  props as DVLProps,
} from "./DoubleVerticalLayout/DoubleVerticalLayout";

const layouts: Array<{
  LayoutComponent: React.FC<LayoutProps>;
  props: PhotoWallLayoutProps;
}> = [
