...
import { initDb, buddyProjectSignup, fetchBuddyProjectSignup, BuddyProjectSignup } from "./buddyprojectFirebase";
...
const BuddyModal: React.FC<BuddyModal> = ({discordUserId, discordUsername, displayName, onClose}) => {
    ...
    const [currentSignup, setCurrentSignup] = React.useState<BuddyProjectSignup | null | undefined>(undefined);
      ...
      <div className="buddy-project-modal">
        <div style={{ height: "100%", width: "100%" }} className="column-center">
          ...
          <div>
            ...
            { currentSignup === null &&
            <>
              <p>Click this button to sign up for the buddy project
                and we'll assign you a buddy real soon! (add more details about when etc)
              </p>
              <p>After you've been assigned a buddy, you will be able to see who it is and how to contact them here.</p>
              ...
              <form onSubmit={(e) => {
                ...
                <button type="submit" className="button buddy-project-entry">GIVE ME A BUDDY</button>
              </form>
            </>}
          </div>
        </div>
